...
interface MoonbirdsInterface extends ethers.utils.Interface {
  functions: {
...
export class Moonbirds extends BaseContract {
  ...
  functions: {
    render(
      ...
      beakId: BigNumberish,
      eyeId: BigNumberish,
      accessoryId: BigNumberish,
      backgroundId: BigNumberish,
